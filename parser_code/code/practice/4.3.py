...
#open xml file
with open("patent_130507.xml", "r", encoding = "utf8") as patent_xml:
    xml = patent_xml.read()
...
ubdg_appli_doc_id_doc_country = doc['us-patent-grant']['us-bibliographic-data-grant']['application-reference']['document-id']['country']
...
ubdg_parties_inventors_inventor_addressbook = doc['us-patent-grant']['us-bibliographic-data-grant']['parties']['inventors']['inventor']['addressbook']
ubdg_parties_inventors_inventor_last_name = doc['us-patent-grant']['us-bibliographic-data-grant']['parties']['inventors']['inventor']['last_name']
ubdg_parties_inventors_inventor_first_name = doc['us-patent-grant']['us-bibliographic-data-grant']['parties']['inventors']['inventor']['first_name']
ubdg_parties_inventors_inventor_city = doc['us-patent-grant']['us-bibliographic-data-grant']['parties']['inventors']['inventor']['address']['city']
ubdg_parties_inventors_inventor_state = doc['us-patent-grant']['us-bibliographic-data-grant']['parties']['inventors']['inventor']['address']['state']
ubdg_parties_inventors_inventor_country = doc['us-patent-grant']['us-bibliographic-data-grant']['parties']['inventors']['inventor']['address']['country']
...
ubdg_examiners_assistant_examiner_last_name = doc['us-patent-grant']['us-bibliographic-data-grant']['examiners']['assistant-examiner']['last-name']
ubdg_examiners_assistant_examiner_first_name = doc['us-patent-grant']['us-bibliographic-data-grant']['examiners']['assistant-examiner']['first-name']
